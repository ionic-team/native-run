...
export type ADBExceptionCode = typeof ERR_NON_ZERO_EXIT | typeof ERR_INCOMPATIBLE_UPDATE;
export class ADBException extends Exception<ADBExceptionCode> {}

export type EmulatorExceptionCode = typeof ERR_ALREADY_RUNNING | typeof ERR_NON_ZERO_EXIT | typeof ERR_UNKNOWN_AVD | typeof ERR_AVD_HOME_NOT_FOUND;
